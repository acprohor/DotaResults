...
public class PresentListActivity extends AppCompatActivity {
    ...
    public class NewThread1 extends AsyncTask<String, Void, String> {
        @Override
        protected String doInBackground(String... strings) {
            Document document;
            Document document2;
            try {
                document = Jsoup.connect("https://www.cybersport.ru/base/match/list/disciplines/dota2/status/detect/page/1/search").userAgent("Mozilla").get();
